...
using FrameworkMessage = AgentHarness.Framework.State.Message;
using FrameworkUsage = AgentHarness.Framework.State.Usage;
using FrameworkStopReason = AgentHarness.Framework.State.StopReason;
using FrameworkToolCall = AgentHarness.Framework.Tools.ToolCall;

namespace AgentHarness.Infrastructure.Anthropic.Model;
