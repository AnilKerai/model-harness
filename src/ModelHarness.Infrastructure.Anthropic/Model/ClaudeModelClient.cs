...
using FrameworkMessage = ModelHarness.Framework.State.Message;
using FrameworkUsage = ModelHarness.Framework.State.Usage;
using FrameworkStopReason = ModelHarness.Framework.State.StopReason;
using FrameworkToolCall = ModelHarness.Framework.Tools.ToolCall;

namespace ModelHarness.Infrastructure.Anthropic.Model;
