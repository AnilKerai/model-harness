...
using FrameworkMessage = SapphireGuard.Framework.State.Message;
using FrameworkUsage = SapphireGuard.Framework.State.Usage;
using FrameworkStopReason = SapphireGuard.Framework.State.StopReason;
using FrameworkToolCall = SapphireGuard.Framework.Tools.ToolCall;

namespace SapphireGuard.Infrastructure.Anthropic.Model;
